...
export interface Settings {
  ...
  randomizer: { skipMovement: boolean; skipCast: boolean; skipScale: boolean; includeGuns: boolean; noNegative: boolean };
...
export const DEFAULT_SETTINGS: Settings = {
  ...
  excludedConfigKeys: [],
  randomizer: { skipMovement: false, skipCast: false, skipScale: true, includeGuns: false, noNegative: true },
  activeProfile: "",
};
