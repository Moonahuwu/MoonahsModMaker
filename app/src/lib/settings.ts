...
export interface Settings {
  ...
  randomizer: { skipMovement: boolean; skipCast: boolean; skipScale: boolean; includeGuns: boolean; noNegative: boolean; randomizeItemTiers: boolean };
...
export const DEFAULT_SETTINGS: Settings = {
  ...
  excludedConfigKeys: [],
  randomizer: { skipMovement: false, skipCast: false, skipScale: true, includeGuns: false, noNegative: true, randomizeItemTiers: false },
  activeProfile: "",
};
