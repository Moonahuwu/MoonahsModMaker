...
either way), `posters` (replace in-world posters/signs/graffiti: `PostersTab` +
...
interiors are NOT inspected (noted in UI). Phase 3 (release helper: zip +
GameBanana description/credits) not built. `particleguide` (`ParticleReference`,
