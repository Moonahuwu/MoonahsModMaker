...
`worldrects` mines every map's world geometry; `curate_uv.py` merges/curates; the old
trans-mask detector was wrong on gutterless text sheets: it fused sign rows and split
