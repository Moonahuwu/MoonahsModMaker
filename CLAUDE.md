...
(`ImportedMods`), and `effects` (VFX recolor, `EffectsBrowser`/`EffectPreview` — hidden
behind `settings.experimentalEffects`). The Heroes tab drills portrait grid (`HeroGrid`)
